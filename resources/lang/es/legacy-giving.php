...
return array (
  ...
  array (
    ...
    'subtitle' => 'Considere irse al bienestar animal al incluir FAAN (<strong>Fundación Familia Amor Animal/strong>) en sus planes finales del patrimonio.',
  ...
  array (
    ...
    'society' => 'Unirse<strong>Sociedad Legacy de Faan/strong>y ser reconocido hoy por una causa en la que cree. (Consulte la información de contacto a continuación).',
    'guide' => 
    array (
      ...
      'plan' => 
      array (
        0 => 'Faan completo<strong>Donación heredada/strong>ystrong>Intención de donación planificada/strong>formas.',
        ...
        3 => 'Incluir<strong>Faan (Fundación Familia Amor Animal)/strong>En tu voluntad final y testamento.',
      ),
    ),
  ),
  'right-column' => 
  ...
  'recaptcha' => 'Este sitio está protegido por Recaptcha y Google<a href=\'https://policies.google.com/privacy\' target=\'_blank\'>política de privacidad/a>ya href=\'https://policies.google.com/terms\' target=\'_blank\'>Términos de servicio/a>aplicar.',
);
